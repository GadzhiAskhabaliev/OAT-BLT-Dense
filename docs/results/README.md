...
| `phase_b_confirm/` | [sim_eval_phase_b/](https://huggingface.co/hackhackhack66666/OAT-BLT-Libero-700/tree/main/sim_eval_phase_b) | ep-0700: 50 ep/task × 3 seeds |
| `phase_b_confirm_ep0950/` | cluster `ep-0950_sr-0.527.ckpt` | **ep-0950 Phase B confirm: 50.60% ± 0.76%** (2026-06-13) |
| `ladder_950/` | cluster `ep-0950_sr-0.527.ckpt` | in-loop screen 52.67% @ ep-950 + training dashboard |
